...
int imu_init(mip_interface *device_interface)
{
  /* Init uart */
  ...
  ///
  if(mip_interface_init(com_port, uart_config.baud_rate, &device_interface, uart_config.defaul_packet_timeout_ms) != MIP_INTERFACE_OK)
    return -1;
